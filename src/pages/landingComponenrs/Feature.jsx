...
function Feature() {
  const features = [
    {
      title: 'Dashboard',
      description: 'View and manage all your boards created on ThoughtShare. Reuse them or invite friends to collaborate and brainstorm together.',
    ...
    },
    {
      ...
      description: 'Work together in real time, interacting and creating on ThoughtShare with seamless collaboration tools.',
      ...
      alt: 'Team collaborating on a digital ThoughtShare in real time',
    },
  ];
...
<div className="grid grid-cols-1 sm:grid-cols-2 gap-6 justify-center justify-items-center">
