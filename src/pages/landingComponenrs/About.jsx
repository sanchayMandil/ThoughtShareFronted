          ...
          <div className="w-full lg:w-3/5">
            ...
            <div className="text-lg lg:text-xl text-gray-600 leading-relaxed space-y-6">
              <p className="animate-slide-up">
                ThoughtShare is an innovative collaboration platform designed to empower teams to brainstorm, make decisions, and create together in real time. Whether you’re planning a major project, outlining ideas, or tackling complex challenges, ThoughtShare provides the tools you need for seamless collaboration.
              </p>
              ...
              <p className="animate-slide-up delay-200">
                From creative teams to business leaders, ThoughtShare offers a dynamic and engaging environment to bring ideas to life, streamline decision-making, and enhance team collaboration, no matter where you are in the world.
              </p>
            </div>
          </div>
          <div className="w-full lg:w-2/5 flex justify-center lg:justify-end mt-8 lg:mt-0">
            <div className="relative">
              <img
                ...
                alt="Team collaborating on a digital ThoughtShare with laptops and creative tools"
              />
